                    ...
                    <div>
                        <div>
                            <Link
                                href="/dashboard"
                                onClick={onLinkClick}
                                className={`flex items-center gap-3 min-w-0 overflow-hidden rounded-md p-2 text-sm transition-all duration-200 hover:bg-primary/30 ${pathname === "/dashboard" ? "bg-primary text-primary-foreground font-semibold" : ""
                                    }`}
                            >
                    ...
                    <div>
                        <div>
                            <Link
                                ...
                                onClick={onLinkClick}
                                className={`flex items-center gap-3 min-w-0 overflow-hidden rounded-md p-2 text-sm transition-all duration-200 hover:bg-primary/30 ${pathname === "/dashboard/add-question" ? "bg-primary text-primary-foreground font-semibold" : ""
                                    }`}
                            >
                        ...
                        <div className="mt-1">
                            <Link
                                ...
                                onClick={onLinkClick}
                                className={`flex items-center gap-3 min-w-0 overflow-hidden rounded-md p-2 text-sm transition-all duration-200 hover:bg-primary/30 ${pathname === "/dashboard/questions" || pathname.startsWith("/dashboard/questions/") ? "bg-primary text-primary-foreground font-semibold" : ""
                                    }`}
                            >
                        ...
                        <div className="mt-1">
                            <Link
                                ...
                                onClick={onLinkClick}
                                className={`flex items-center gap-3 min-w-0 overflow-hidden rounded-md p-2 text-sm transition-all duration-200 hover:bg-primary/30 ${pathname === "/dashboard/upload" ? "bg-primary text-primary-foreground font-semibold" : ""
                                    }`}
                            >
                        ...
                        <div className="mt-1">
                            <Link
                                ...
                                onClick={onLinkClick}
                                className={`flex items-center gap-3 min-w-0 overflow-hidden rounded-md p-2 text-sm transition-all duration-200 hover:bg-primary/30 ${pathname === "/dashboard/contents" ? "bg-primary text-primary-foreground font-semibold" : ""
                                    }`}
                            >
                    ...
                    <div>
                        <div>
                            <Link
                                ...
                                onClick={onLinkClick}
                                className={`flex items-center gap-3 min-w-0 overflow-hidden rounded-md p-2 text-sm transition-all duration-200 hover:bg-primary/30 ${pathname === "/dashboard/create-agent" ? "bg-primary text-primary-foreground font-semibold" : ""
                                    }`}
                            >
                                <PlusIcon className="h-4 w-4 shrink-0" />
                    ...
                    <div className="mt-1">
                        <div>
                            <Link
                                ...
                                onClick={onLinkClick}
                                className={`flex items-center gap-3 min-w-0 overflow-hidden rounded-md p-2 text-sm transition-all duration-200 hover:bg-primary/30 ${pathname === "/dashboard/agents" || pathname.startsWith("/dashboard/agents/") ? "bg-primary text-primary-foreground font-semibold" : ""
                                    }`}
                            >
                    ...
                    <div>
                        <div>
                            <Link
                                ...
                                onClick={onLinkClick}
                                className={`flex items-center gap-3 min-w-0 overflow-hidden rounded-md p-2 text-sm transition-all duration-200 hover:bg-primary/30 ${pathname === "/dashboard/users" || pathname.startsWith("/dashboard/users/") ? "bg-primary text-primary-foreground font-semibold" : ""
                                    }`}
                            >
