          ...
          <div className="mx-auto max-w-7xl p-6">
            <header className="mb-6 flex items-center justify-between">
              <div className="flex items-center gap-3">
                {/* Mobile hamburger to open the sidebar as a drawer */}
            ...
            <main className="grid grid-cols-1 gap-6 md:grid-cols-3">
              <div className="rounded-lg border bg-white p-4 shadow-sm">
                ...
                <p className="mt-1 text-sm text-muted-foreground">+12% this month</p>
              </div>

              <div className="rounded-lg border bg-white p-4 shadow-sm">
                <h3 className="text-lg font-medium">New Signups</h3>
                <p className="mt-2 text-3xl font-bold">234</p>
                <p className="mt-1 text-sm text-muted-foreground">+8% this month</p>
              </div>

              <div className="rounded-lg border bg-white p-4 shadow-sm">
                <h3 className="text-lg font-medium">Reports</h3>
                <p className="mt-2 text-3xl font-bold">12</p>
                <p className="mt-1 text-sm text-muted-foreground">2 unresolved</p>
              </div>
            </main>
